...
export function getWhatsAppEnrollmentUrl(courseTitle: string) {
  const message = encodeURIComponent(
    `Hello, I'm interested in enrolling in the ${courseTitle} course. I'd like to know more about the course details, schedule, duration, fees, and how to get started.`
  );
