            ...
            <div className="lg:col-span-2">
              ...
              >
                ...
                <div className="max-w-2xl">
                  <h2 className="text-3xl font-black mb-6">About the course</h2>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-32">
                <div className="p-8 bg-black rounded-[2.5rem] text-white shadow-2xl">
                  <div className="mb-8">
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mb-2">Total Investment</p>
                  ...
                  <div className="space-y-5 mb-8">
                    ...
                    <div className="flex items-center justify-between pb-4 border-b border-white/10 text-sm">
                      <div className="flex items-center gap-2 text-gray-400">
                        <BarChart size={16} /> <span>Level</span>
                      </div>
                  ...
                  <Link href="/register">
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full py-5 bg-white text-black rounded-full font-black text-lg shadow-lg"
                    >
                      Enroll Now
                    </motion.button>
                  </Link>
