    ...
    <main className="font-cabinet-grotesk overflow-hidden bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-xl text-slate-500 max-w-lg mb-10 leading-relaxed font-medium">
                Join Ibadan's premier ICT academy. Master high-demand tech skills through project-based learning and expert mentorship.
              </p>
            ...
            >
              ...
              <div className="absolute -bottom-10 -left-10 bg-[#00A3FF] p-8 rounded-[2rem] shadow-xl max-w-[200px] text-[#003366]">
                ...
                <p className="font-black text-2xl leading-tight">10+ Years</p>
                <p className="text-[#003366]/70 text-sm font-bold uppercase tracking-tighter">Of Excellence</p>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-8 text-center">
          <p className="text-xs font-bold uppercase tracking-[0.4em] text-slate-400 mb-12">Affiliated with top industry bodies</p>
      ...
      <section className="py-32 px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
            <div>
              <span className="text-[#00A3FF] font-black uppercase tracking-widest text-sm">Popular Programs</span>
              <h2 className="text-5xl md:text-7xl font-black tracking-tight leading-none mt-4 text-[#003366]">Build Your <br /> Future.</h2>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-6xl font-black leading-[0.9] mb-12">
                Why study at <br /> <span className="text-[#00A3FF]">Parach ICT?</span>
              </h2>
              
              <div className="space-y-10">
                {[
                  { title: "Project-Based Learning", desc: "We don't just teach theory; you build real-world products." },
                  { title: "Industry Certification", desc: "Get certificates recognized by top global employers." },
                  { title: "Job Placement Support", desc: "Access our network of hiring partners upon graduation." }
                ].map((item, i) => (
      ...
      <section className="py-40 text-center px-8 bg-white">
        <span className="text-[#003366] font-black uppercase tracking-[0.5em] text-xs">Transform your life</span>
        <h2 className="text-7xl md:text-9xl font-black tracking-tighter mt-8 mb-12 italic text-[#003366]">
          READY TO <span className="text-[#00A3FF] not-italic">START?</span>
        </h2>
